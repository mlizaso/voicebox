...
For verbatim book narration, leave personality rewriting off: this mode intentionally
changes the input words before TTS. The private audiobook workflow freezes its own text.
